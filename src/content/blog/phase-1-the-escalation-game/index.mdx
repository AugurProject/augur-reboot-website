...
<ProseCard>
**ARCHIVED RECORD** — The escalation and migration phases described in this post are complete. The linked tools and guide are historical references, not current instructions. For the current record, see the [Moon Fork case study](/learn/fork/moon-fork/) and [FAQ](/faq/).
</ProseCard>
...
Step-by-step guide: [Migration Guide](https://www.augur.net/learn/fork/migration/) (historical archive)

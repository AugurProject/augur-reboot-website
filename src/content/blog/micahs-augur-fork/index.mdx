...
<ProseCard>
**MIGRATION CLOSED** — The fork and migration instructions described in this post are historical. The Moon Fork migration window closed on August 3, 2026; this post is preserved as published, not current guidance. For the current record, see the [Moon Fork case study](/learn/fork/moon-fork/) and [FAQ](/faq/).
</ProseCard>

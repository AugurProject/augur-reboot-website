...
function buttonVariants({ variant, size }: { variant: string; size: string }) {
	const base =
		"tracking-wide font-display inline-flex items-center justify-center whitespace-nowrap font-medium transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 hover:cursor-pointer";
